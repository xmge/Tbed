...
;(function(global,$){
    ...
    var cssMap={
        ...
        '.toast-message__closeBtn:before':'{position:absolute;display:block;left:0;top:0;width:100%;height:100%;content:"¡Á";font-size:16px;}',
        ...
        '.toast-icon--error:before':'{content:"¡Á";color:#fff;}',
